...
import { Conversation, CreateConversationRequest, QueryMessagesRequest, User, Message } from "../common/messaging";
...
export class UsersService {
    ...
    queryMessages(request: QueryMessagesRequest): Observable<Message> {
        ...
        if (!stream) {
            // Create a new stream if it doesn't exist (e.g., for newly created conversations)
